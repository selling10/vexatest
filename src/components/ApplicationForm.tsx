    ...
    >
      ...
      <div className="relative container mx-auto my-12 p-4 bg-white bg-opacity-80 rounded-lg shadow-md max-w-4xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <h2 className="text-3xl font-bold mb-4 mt-5">Vi köper din fastighet till marknadsvärde</h2>
            <p className="mb-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg shadow-inner">
            <h3 className="text-2xl font-bold mb-6">Ansök och få ett bud</h3>
            <form>
              <div className="mb-4">
                <label className="block text-left font-semibold mb-2">Namn</label>
                <input type="text" className="w-full px-4 py-2 border rounded-lg" placeholder="Namn" />
              </div>
              <div className="mb-4">
                <label className="block text-left font-semibold mb-2">Telefonnummer</label>
                <input type="text" className="w-full px-4 py-2 border rounded-lg" placeholder="07XX XXX XXX" />
              </div>
              <div className="mb-4">
                <label className="block text-left font-semibold mb-2">E-postadress</label>
                <input type="email" className="w-full px-4 py-2 border rounded-lg" placeholder="Skriv e-postadress" />
              </div>
              <div className="mb-4">
                <label className="block text-left font-semibold mb-2">Företagets Organisationsnummer</label>
                <input type="text" className="w-full px-4 py-2 border rounded-lg" placeholder="Skriv organisationsnummer" />
              </div>
              <div className="mb-4">
                <label className="block text-left font-semibold mb-2">Fastighetens Adress</label>
                <input type="text" className="w-full px-4 py-2 border rounded-lg" placeholder="Skriv adress" />
              </div>
              <div className="mb-4">
                <label className="block text-left font-semibold mb-2">Postnummer</label>
                <input type="text" className="w-full px-4 py-2 border rounded-lg" placeholder="Skriv postnummer" />
              </div>
              <div className="mb-4">
                <label className="block text-left font-semibold mb-2">Ort</label>

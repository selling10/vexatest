export const Omoss = () => {
  return (
    <section id="omoss" className="py-8 sm:py-12 bg-[#EFE3E3] w-full">
          ...
          <div className="flex flex-col gap-8 md:gap-12">
            <div className="flex flex-col justify-between">
              <div className="pb-6">
                ...
                <p className="text-xl mt-4 " style={{ color: "#454545" }}>
                  Vill ni veta mera? Hör av er på <a className="text-black underline">info@vexa.se</a> eller skicka in en ansökan <a href="#apply" className="text-black underline">här</a>, vi svarar vanligtvis inom 24 timmar.
                </p>
              </div>
            </div>
          </div>

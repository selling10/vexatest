...
const PrivacyPolicy: React.FC = () => {
  ...
  return (
    <div className="container mx-auto my-0 mt-0 bg-[#EFE3E3] p-8 max-w-3xl">
      ...
      <p className="mb-4">
        Vexa Industrihus är personuppgiftsansvariga för behandlingen av dina personuppgifter.
      </p>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold mb-2">1. Syfte, uppgifter och lagringsperiod</h3>
      <p className="mb-4">
      ...
      <h4 className="text-lg font-semibold mb-2">1.1 Kontakt – via telefon, post, e-post och/eller webbformulär</h4>
      <p className="mb-4">
      ...
      <h4 className="text-lg font-semibold mb-2">1.2 Sammanställning och analys av statistik för att förbättra webbplatsen</h4>
      <p className="mb-4">
        För detta syfte använder vi följande uppgifter:
        <ul className="list-disc list-inside ml-4">
          <li>IP-adress</li>
      ...
      <h4 className="text-lg font-semibold mb-2">1.3 För att kunna erbjuda anpassade personliga produkter och tjänster</h4>
      <p className="mb-4">
        För detta syfte använder vi följande uppgifter:
        <ul className="list-disc list-inside ml-4">
          <li>Ett för- och efternamn</li>
      ...
      <h4 className="text-lg font-semibold mb-2">2.1 Nödvändiga cookies</h4>
      <p className="mb-4">
      ...
      <h4 className="text-lg font-semibold mb-2">2.2 Analytiska cookies</h4>
      <p className="mb-4">
      ...
      <h4 className="text-lg font-semibold mb-2">2.3 Funktionella cookies</h4>
      <p className="mb-4">
      ...
      <h4 className="text-lg font-semibold mb-2">2.4 Målinriktade cookies</h4>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold mb-2">3. Praxis för offentliggörande av uppgifter</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold mb-2">4. Säkerhet</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold mb-2">5. Tredje-parts webbplatser</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold mb-2">6. Ändringar av denna integritetspolicy</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold mb-2">7. Tillgång till och ändring av dina uppgifter</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold mb-2">8. Inlämning av klagomål</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold mb-2">9. Kontaktuppgifter</h3>
      <p className="mb-4">
        Vexa Industrihus
        <br />
        ...
        Sverige
        <br />
        Webbplats: <a href="https://vaxaindustrihus.se" className="text-blue-600">https://vaxaindustrihus.se</a>
        <br />
        E-post: <a href="mailto:info@vaxaindustrihus.se" className="text-blue-600">info@vaxaindustrihus.se</a>
        <br />
